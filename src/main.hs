...
{-
 - Leitura de um caractere para o tipo inteiro
 -}
...
{-
 - Busca uma peça no tabuleiro e retorna a sua posição na linha
 -}
procura_peca :: Char -> [Char] -> Int
procura_peca peca_procurada lst = procura peca_procurada 0 lst

{-
 - Função complementar à procura_peca para realizar a busca da peça no tabuleiro 
 -}
